      ...
      {showNav && (
        <nav className="fixed bottom-0 left-0 right-0 bg-white border-t px-2 py-2 max-w-md mx-auto z-50">
          <div className="flex justify-around items-center">
            <Link href="/" className={cn("flex flex-col items-center gap-1 flex-1 py-2 rounded-lg transition-colors", location === "/" ? "text-primary bg-primary/10" : "text-muted-foreground hover:bg-muted")}>
